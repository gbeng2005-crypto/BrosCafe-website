    ...
    return (
      <section id="moment" data-testid="bros-moment-section" className="relative">
        <div className="mx-auto max-w-[1440px] px-6 py-24 text-center md:px-12">
          <h2 className="font-serif-display text-5xl font-medium text-[#66734A] md:text-7xl">{t.intro}</h2>
        </div>
        <div className="relative h-[70vh]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#66734A]/40 text-center">
            <p className="font-serif-display text-4xl italic text-[#F5F0E6] md:text-6xl">{t.caption}</p>
            <p className="mt-4 text-xs tracking-[0.3em] text-[#F5F0E6]/80">{t.sub}</p>
          </div>
        </div>
      </section>
    );
